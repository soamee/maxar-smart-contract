...
flow accounts add-contract MaxarNFT ./contracts/MaxarNFT.cdc --signer mainnet-account --network mainnet
...
flow accounts create \
  ...
  --contract MaxarNFT:./contracts/MaxarNFT.cdc
